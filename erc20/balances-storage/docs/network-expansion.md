...
The BSC campaign now includes 140 qualified profiles: the original top 100 plus
40 from ranks 101–150. The [current proxy follow-up](ranked-proxy-coverage.md)
retains the other 10 candidates as unqualified. This is a bounded campaign. Completing it
