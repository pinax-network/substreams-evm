...
The sink key `log_index` remains the Substreams-derived row position, while `log_block_index` preserves the native EVM block-relative log position from the protobuf payload.
