...
pub fn set_template_erc20_tx(encoding: &Encoding, tx: &erc20_pb::Transaction, tx_index: usize, row: &mut substreams_database_change::tables::Row) {
...
pub fn set_template_tokens_tx(encoding: &Encoding, tx: &tokens_pb::Transaction, tx_index: usize, row: &mut substreams_database_change::tables::Row) {
    let tx_to = match tx.to.as_ref() {
        Some(addr) => bytes_to_string(addr, encoding),
        None => "".to_string(),
    };
...
pub fn set_template_erc4626_tx(encoding: &Encoding, tx: &erc4626_pb::Transaction, tx_index: usize, row: &mut substreams_database_change::tables::Row) {
    let tx_to = match tx.to.as_ref() {
        Some(addr) => bytes_to_string(addr, encoding),
        None => "".to_string(),
    };
...
pub fn set_template_native_tx(encoding: &Encoding, tx: &native_pb::Transaction, tx_index: usize, row: &mut substreams_database_change::tables::Row) {
    let tx_to = match tx.to.as_ref() {
        Some(addr) => bytes_to_string(addr, encoding),
        None => "".to_string(),
    };
