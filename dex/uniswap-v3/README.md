...
`map_events` emits the existing transaction-level `uniswap.v3.Events` output.
...
The previous `map_pool_changes` module is no longer built here. Previously pinned
