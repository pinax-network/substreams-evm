...
CREATE TABLE IF NOT EXISTS swaps ON CLUSTER 'tokenapis-a' (
    -- block --
    block_num                   UInt32,
    block_hash                  String,
...
CREATE MATERIALIZED VIEW IF NOT EXISTS mv_swaps_sunpump_token_purchased ON CLUSTER 'tokenapis-a'
TO swaps AS
SELECT
    -- block --
    block_num,
...
CREATE MATERIALIZED VIEW IF NOT EXISTS mv_swaps_sunpump_token_sold ON CLUSTER 'tokenapis-a'
TO swaps AS
SELECT
    -- block --
    block_num,
...
CREATE MATERIALIZED VIEW IF NOT EXISTS mv_swaps_uniswap_v1_token_purchase ON CLUSTER 'tokenapis-a'
TO swaps AS
SELECT
    -- block --
    block_num,
...
CREATE MATERIALIZED VIEW IF NOT EXISTS mv_swaps_uniswap_v1_eth_purchase ON CLUSTER 'tokenapis-a'
TO swaps AS
SELECT
    -- block --
    block_num,
...
CREATE MATERIALIZED VIEW IF NOT EXISTS mv_swaps_uniswap_v2_swap ON CLUSTER 'tokenapis-a'
TO swaps AS
SELECT
    -- block --
    block_num,
...
-- Uniswap V3 Swap
CREATE MATERIALIZED VIEW IF NOT EXISTS mv_swaps_uniswap_v3_swap ON CLUSTER 'tokenapis-a'
TO swaps AS
SELECT
    -- block --
    block_num,
...
-- Uniswap V4 Swap
CREATE MATERIALIZED VIEW IF NOT EXISTS mv_swaps_uniswap_v4_swap ON CLUSTER 'tokenapis-a'
TO swaps AS
SELECT
    -- block --
    block_num,
...
CREATE MATERIALIZED VIEW IF NOT EXISTS mv_swaps_curvefi_token_exchange ON CLUSTER 'tokenapis-a'
TO swaps AS
SELECT
    -- block --
    block_num,
...
CREATE MATERIALIZED VIEW IF NOT EXISTS mv_swaps_balancer_vault_swap ON CLUSTER 'tokenapis-a'
TO swaps AS
SELECT
    -- block --
    block_num,
...
CREATE MATERIALIZED VIEW IF NOT EXISTS mv_swaps_bancor_conversion ON CLUSTER 'tokenapis-a'
TO swaps AS
SELECT
    -- block --
    block_num,
