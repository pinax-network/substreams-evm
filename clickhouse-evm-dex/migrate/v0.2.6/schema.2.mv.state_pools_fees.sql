...
CREATE TABLE IF NOT EXISTS state_pools_fees ON CLUSTER 'tokenapis-a' (
    -- block --
    block_num                   UInt32,
    block_hash                  String,
...
CREATE MATERIALIZED VIEW IF NOT EXISTS mv_state_pools_fees_uniswap_v1_new_exchange_fee ON CLUSTER 'tokenapis-a'
...
CREATE MATERIALIZED VIEW IF NOT EXISTS mv_state_pools_fees_uniswap_v2_pair_created_fee ON CLUSTER 'tokenapis-a'
TO state_pools_fees AS
SELECT
    -- block --
    block_num,
...
CREATE MATERIALIZED VIEW IF NOT EXISTS mv_state_pools_fees_uniswap_v3_pool_created_fee ON CLUSTER 'tokenapis-a'
TO state_pools_fees AS
SELECT
    -- block --
    block_num,
...
CREATE MATERIALIZED VIEW IF NOT EXISTS mv_state_pools_fees_uniswap_v4_initialize_fee ON CLUSTER 'tokenapis-a'
TO state_pools_fees AS
SELECT
    -- block --
    block_num,
...
CREATE MATERIALIZED VIEW IF NOT EXISTS mv_state_pools_fees_curvefi_plain_pool_deployed_fee ON CLUSTER 'tokenapis-a'
TO state_pools_fees AS
SELECT
    -- block --
    block_num,
...
CREATE MATERIALIZED VIEW IF NOT EXISTS mv_state_pools_fees_curvefi_meta_pool_deployed_fee ON CLUSTER 'tokenapis-a'
TO state_pools_fees AS
SELECT
    -- block --
    block_num,
...
CREATE MATERIALIZED VIEW IF NOT EXISTS mv_state_pools_fees_balancer_swap_fee_percentage ON CLUSTER 'tokenapis-a'
TO state_pools_fees AS
SELECT
    -- block --
    block_num,
...
CREATE MATERIALIZED VIEW IF NOT EXISTS mv_state_pools_fees_balancer_aggregate_swap_fee_percentage ON CLUSTER 'tokenapis-a'
TO state_pools_fees AS
SELECT
    -- block --
    block_num,
...
CREATE MATERIALIZED VIEW IF NOT EXISTS mv_state_pools_fees_bancor_conversion_fee_update ON CLUSTER 'tokenapis-a'
TO state_pools_fees AS
SELECT
    -- block --
    block_num,
...
CREATE MATERIALIZED VIEW IF NOT EXISTS mv_state_pools_fees_curvefi_commit_new_fee ON CLUSTER 'tokenapis-a'
TO state_pools_fees AS
SELECT
    -- block --
    block_num,
...
-- Curve.fi::NewFee --
CREATE MATERIALIZED VIEW IF NOT EXISTS mv_state_pools_fees_curvefi_new_fee ON CLUSTER 'tokenapis-a'
TO state_pools_fees AS
SELECT
    -- block --
    block_num,
...
CREATE MATERIALIZED VIEW IF NOT EXISTS mv_state_pools_fees_sunpump_purchase_fee_set ON CLUSTER 'tokenapis-a'
TO state_pools_fees AS
SELECT
    -- block --
    block_num,
...
-- SunPump::SaleFeeSet --
CREATE MATERIALIZED VIEW IF NOT EXISTS mv_state_pools_fees_sunpump_sale_fee_set ON CLUSTER 'tokenapis-a'
TO state_pools_fees AS
SELECT
    -- block --
    block_num,
