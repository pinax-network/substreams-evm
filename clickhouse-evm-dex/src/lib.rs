...
use proto::pb::foundational_store::v1::{NewExchange, PairCreated, TokenCreate};
...
pub fn db_out(
    ...
    store_token_create: StoreGetProto<TokenCreate>,
    ...
    sunpump::process_events(&mut tables, &clock, &sunpump, &store_token_create);
