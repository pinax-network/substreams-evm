...
SELECT
    ...
    quantileDeterministicMerge({high_quantile: Float32})(quantile0) as high_quantile0,
    quantileDeterministicMerge({low_quantile: Float32})(quantile0) as low_quantile0,
